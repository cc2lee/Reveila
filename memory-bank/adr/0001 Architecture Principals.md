...
4. UniversalInvocationBridge (UIB): The Agentic Control Plane. It is the dedicated gateway for AI-originated tool calls. Before an AI intent is allowed to reach the proxy system, the UIB performs:
