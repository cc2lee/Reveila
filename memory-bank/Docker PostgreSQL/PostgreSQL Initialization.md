...
If it's empty: Postgres runs its internal initdb command. It creates the system tables, the reveila_db database, and the user admin. You will see files like PG_VERSION and base/ suddenly appear in your Windows ../data/postgres folder.
