...
public class ConfigurationLinter {
    ...
    public void lint(Collection<MetaObject> allMetas) throws Exception {
        ...
        for (MetaObject meta : allMetas) {
            ...
            for (String depName : deps) {
                ...
                if (meta.getStartPriority() < depMeta.getStartPriority()) {
                    System.out.format("⚠️ Warning: %s (P:%d) starts before dependency %s (P:%d)\n",
        ...
        System.out.println("✅ Orchestration Linting Complete.");
    }
}